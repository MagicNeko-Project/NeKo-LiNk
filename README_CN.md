...
- **🎭 Fake-TCP 插件化模式 (Fake-TCP Mode)**: 极致的穿透魔法！通过集成高性能插件 [udp2raw](https://github.com/wangyu-/udp2raw-multi)，将所有流量透明地伪装成合法的 TCP 流量。这一过程完全由 `nekolink-ctl` 自动化管理，无需复杂的手动配置喵。
