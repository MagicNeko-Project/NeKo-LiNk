...
- **🤝 强化的信令交互 (Robust Signaling)**: 架构级重塑喵！为了极大提升 NAT 穿透成功率，我们将信令角色切换为“服务端/客户端”严格解耦模式。服务端变为纯粹的被动监听，而客户端负责主动发起“撩拨”。即使在复杂的网络环境下，只要一端能被触达，猫娘就能通过加密信令通道自动同步双向公钥与 MTU 喵。
...
- **💤 智能信令停机 (Smart Halt)**: 为了极智隐蔽，隧道连接成功后，信令交换会自动对该对端进入深度休眠。在非 Mesh 模式下，这种“一劳永逸”的策略能显著降低特征。配合 Keepalive 魔法，连接稳如磐石喵！
...
- **攻防兼备的信令**：Mesh 节点会自动同时担任服务端与客户端角色，既静候佳音也主动出击，确保在复杂的 NAT 环境下全网秒级互联喵！
