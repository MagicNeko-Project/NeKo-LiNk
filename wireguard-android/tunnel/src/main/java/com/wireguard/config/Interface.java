...
public final class Interface {
    ...
    private final Optional<String> nekoKey;
        ...
        for (final CharSequence line : lines) {
            ...
            switch (attribute.getKey().toLowerCase(Locale.ENGLISH)) {
                ...
                case "privatekey":
                    ...
                    break;
                case "nekolinkkey":
                    builder.parseNekoKey(attribute.getValue());
                    break;
                default:
    ...
    /**
     * Returns the NekoLink signaling key.
     *
     * @return the NekoLink signaling key, or {@code Optional.empty()} if none is configured
     */
    public Optional<String> getNekoKey() {
        return nekoKey;
    }
    ...
    public String toString() {
        ...
        nekoKey.ifPresent(nk -> sb.append(" NekoLink"));
        sb.append(')');
        return sb.toString();
    }
    ...
    public String toWgQuickString() {
        ...
        nekoKey.ifPresent(nk -> sb.append("NekoLinkKey = ").append(nk).append('\n'));
        return sb.toString();
    }
    ...
    public static final class Builder {
        ...
        // Defaults to not present.
        private Optional<String> nekoKey = Optional.empty();
        ...
        public Builder parseNekoKey(final String nekoKey) {
            return setNekoKey(nekoKey);
        }
        ...
        public Builder setNekoKey(final String nekoKey) {
            this.nekoKey = (nekoKey == null || nekoKey.isEmpty()) ? Optional.empty() : Optional.of(nekoKey);
            return this;
        }
    }
}
