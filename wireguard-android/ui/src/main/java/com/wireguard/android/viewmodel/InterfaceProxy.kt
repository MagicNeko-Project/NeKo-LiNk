...
class InterfaceProxy : BaseObservable, Parcelable {
    ...
    var nekoKey: String = ""
        set(value) {
            field = value
            notifyPropertyChanged(BR.nekoKey)
        }
    ...
    fun resolve(): Interface {
        ...
        if (nekoKey.isNotEmpty()) builder.parseNekoKey(nekoKey)
